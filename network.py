...
class Network(object):
    ...
    def SGD(self, training_data, epochs, num_batches, eta, test_data=None):
        ...
        for mini_batch in np.array_split(training_data, num_batches):
        ...
        #     mini_batches = np.array_split(training_data, num_batches)
